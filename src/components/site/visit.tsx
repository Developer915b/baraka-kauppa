      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            className="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-stone-200/70 dark:bg-stone-900 dark:ring-stone-800"
          >
            {/* Stylised map area */}
            ...
            <div className="p-6 sm:p-8">
              <h3 className="flex items-center gap-2 text-lg font-semibold text-stone-900 dark:text-stone-50">
                <MapPin className="h-5 w-5 text-emerald-700 dark:text-emerald-400" aria-hidden="true" />
          ...
          <motion.div
            ...
            className="flex flex-col overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-stone-200/70 dark:bg-stone-900 dark:ring-stone-800"
          >
            <div className="p-6 sm:p-8">
              <h3 className="flex items-center gap-2 text-lg font-semibold text-stone-900 dark:text-stone-50">
                <Clock className="h-5 w-5 text-emerald-700 dark:text-emerald-400" aria-hidden="true" />
                {t.visit.hoursTitle}
              </h3>
              <ul className="mt-4 divide-y divide-stone-100 dark:divide-stone-800">
                {hoursRows.map((row) => (
                  ...
                  >
                    <span className="text-stone-700 dark:text-stone-300">{row.day}</span>
                    <span className="font-semibold text-stone-900 dark:text-stone-100">{row.time}</span>
                  </li>
                ))}
              </ul>
              <p className="mt-3 text-xs text-stone-500 dark:text-stone-400">{t.visit.hoursNote}</p>
            </div>
            <div className="mt-auto border-t border-stone-100 bg-amber-50/60 p-6 dark:border-stone-800 dark:bg-amber-400/10 sm:p-8">
              <h3 className="flex items-center gap-2 text-lg font-semibold text-stone-900 dark:text-stone-50">
                <Facebook className="h-5 w-5 text-stone-700 dark:text-stone-300" aria-hidden="true" />
                {t.visit.fbButton}
              </h3>
              ...
              <Button
                asChild
                variant="outline"
                className="mt-4 rounded-full border-emerald-700/40 text-emerald-800 hover:bg-emerald-50 hover:text-emerald-900 dark:border-emerald-500/40 dark:text-emerald-300 dark:hover:bg-stone-800 dark:hover:text-emerald-200"
              >
