...
export const translations = {
  en: {
    ...
    cart: {
      ...
      freeDeliveryHint: "You save the delivery fee on orders over €{free}!",
    ...
    checkout: {
      ...
      deliveryDesc: "€{fee} — free over €{free} · {area}",
      pickup: "Pick up in store",
      pickupDesc: "Free — {address}",
    ...
    product: {
      ...
      deliveryText:
        "€{fee} home delivery in the {area} — free on orders over €{free}. Pay on delivery.",
      pickupText:
        "Free pickup from the store at {address} — ready when you arrive.",
      qualityText:
    ...
    account: {
      ...
      signInSubtitle: "Track your orders and check out faster.",
      createTitle: "Create your account",
      createSubtitle: "Keep your order history in one place.",
      name: "Full name",
      email: "Email",
      ...
      noOrders: "You haven't ordered yet — your orders will appear here.",
      orderNo: "Order",
      items: "Items",
      total: "Total",
      memberSince: "Member",
    ...
    cart: {
      ...
      freeDeliveryHint: "Yli {free} € tilauksissa toimitus on maksuton!",
    ...
    checkout: {
      ...
      deliveryDesc: "{fee} — ilmainen yli {free} € · {area}",
      pickup: "Nouto kaupasta",
      pickupDesc: "Ilmainen — {address}",
    ...
    product: {
      ...
      description: "Kuvaus",
      deliveryText:
        "Kotiinkuljetus {fee} ({area}) — ilmainen yli {free} € tilauksissa. Maksu toimituksen yhteydessä.",
      pickupText: "Ilmainen nouto kaupasta {address} — valmiina kun saavut.",
      qualityText:
    ...
    account: {
      ...
      signInSubtitle: "Seuraa tilauksiasi ja maksa nopeammin.",
      createTitle: "Luo oma tilisi",
      createSubtitle: "Saat tilaushistorian kätevästi yhteen paikkaan.",
      name: "Koko nimi",
      email: "Sähköposti",
      ...
      signedInAs: "Kirjautunut",
      orderHistory: "Tilauksesi",
      noOrders: "Et ole vielä tilannut — tilauksesi näkyvät täällä.",
      orderNo: "Tilaus",
      items: "Tuotteet",
      total: "Yhteensä",
      memberSince: "Jäsen",
